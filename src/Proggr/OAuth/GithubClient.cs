namespace Proggr.OAuth
{
    ...
    public class GithubClient : OAuth2Client
    {
        ...
        public override void RequestAuthentication( System.Web.HttpContextBase context, Uri returnUrl )
        {
            base.RequestAuthentication( context, returnUrl );
        }

        public new DotNetOpenAuth.AspNet.AuthenticationResult VerifyAuthentication( System.Web.HttpContextBase context )
        {
            return base.VerifyAuthentication( context, null );
        }

        public override DotNetOpenAuth.AspNet.AuthenticationResult VerifyAuthentication( System.Web.HttpContextBase context, Uri returnPageUrl )
        {
